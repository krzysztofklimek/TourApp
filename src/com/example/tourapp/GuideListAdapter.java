...
public class GuideListAdapter extends ArrayAdapter<Tour> {

	
	GuideListAdapter(Context context, ArrayList<Tour> tours) {
		super(context, R.layout.list_guide, tours);
	}

	@Override
	public View getView(int position, View convertView, ViewGroup parent) {
		LayoutInflater inflater = LayoutInflater.from(getContext());
		View customView = inflater.inflate(R.layout.list_guide, parent, false);
